...
output_file = "./csv-output/last/"+dataset+"/last-"+dataset+"-ALL.csv"
...
with open(output_file, "a") as b:
    ...
    for beta_num in range(13):
        ...
        print("-----------------------------------\nAcquiring values for beta =", beta, "for the "+dataset+" dataset.")
        ...
        modelPath = './DATA/'+filename+'-beta'+str(beta_num)+'-'+dataset+'-15000' # trained model (graph/meta, index, data/weights)
        ...
        with open("./csv-output/last/"+dataset+"/last-beta"+str(beta_num)+"-"+dataset+".csv", "a") as h:
            print("{},{},{},{},{},{}".format(cizy, cizx, cacc, cavg, cerr, cavgerr), file=h)
