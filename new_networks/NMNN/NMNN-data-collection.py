'''
NMNN stands for Normal MNIST Normal (sized) Network
...
for beta_num in range(0, 13): # range(0, 13) results in beta = 1e-0 to 1e-12
    ...
    batch_size = 100
    steps_per_batch = int(mnist_data.test.num_examples / batch_size) # = 600
    ...
    csvname = "./csv-output/full/full-NMNN-beta"+str(beta_num)+'-'+dataset+'.csv'
    dataname = './DATA/'+dataset+'/NMNN-beta'+str(beta_num)+'-'+dataset
