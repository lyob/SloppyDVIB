...
with open("./csv-output/full-buff0-beta1-test.csv", "a") as f:
...
savepth = saver.save(sess, './DATA/mnist-8x8-buff0-beta0-test', global_step) ## data is stored here
...
cavgerr /= tot
print(cizy)
with open("./csv-output/avgd-final-buff9-beta2.csv", "a") as h:
