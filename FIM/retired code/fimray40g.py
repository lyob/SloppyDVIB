...
weight_change = 0.01
beta = 2
size = 10 # size of network is 20002
...
def calculate_fim(scores, softmax):
    ...
    # instead of waiting for all 10 to be done, just add them together as soon as they're ready
    ...
    print('The 10 matrices have been element-wise added together.')
