...
def calc_original():
    ...
    with sess0 as sess:
        ...
        return e1w_val, e2w_val, e3w_val, dw_val, e1b_val, e2b_val, e3b_val, db_val, softmax
    sess.close()
...
def calc_scores_all_labels():
    # calculate unmodified network first to get weight and softmax values
    print("********************** Extracting variables from unmodified network *****************************")
    e1w_val, e2w_val, e3w_val, dw_val, e1b_val, e2b_val, e3b_val, db_val, softmax = calc_original()
    out = {
...
def main():
    ...
    # fim1.py and fim2.py
    scores, softmax = calc_scores_all_labels()
    # I need to figure out how to run these in parallel using multiprocessing
