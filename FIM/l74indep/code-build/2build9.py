...
# paths
loadpath = '/home/blyo/python_tests/l74indep/data-scores/'
outpath = '/dali/sepalmer/blyo/l74indep/data-fim/'
jsonpath = outpath
...
def export_fim(matrix):
    np.save(outpath+'b{}-fim2.npy'.format(beta), matrix)
    print("The FIM matrix has been exported as b{}-fim2.npy".format(beta))
...
def calculate_fim(scores, softmax, start, end):
    ...
    ready_ids, _ = ray.wait(obj_ids, num_returns=end-start, timeout=None) # there should be 5 results, order is preserved
