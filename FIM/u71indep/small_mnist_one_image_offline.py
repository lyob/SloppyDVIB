...
def read_data_sets():
    ...
    offset = 6  # for other values, run extract_labels.py
    test_images = X_digits[train_size+offset:train_size+offset+1]
    print("test images size", test_images.shape)
    test_labels = y_digits[train_size+offset:train_size+offset+1]
    print('the test label value is {}'.format(test_labels))
