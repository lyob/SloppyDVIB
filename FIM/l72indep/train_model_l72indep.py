...
for beta_num in range(0,13):
    ...
    if beta_num == 0:
        ...
        csvname = basepath+"/data-csv-{}{}/{}-beta{}.csv".format(labelname, modelname, modelname, beta_num)
        dataname = basepath+'/data-model-{}{}/{}-beta{}'.format(labelname, modelname, modelname, beta_num) 
    ...
    # for all other beat 
        ...
        modelpath = './model/{}-beta{}-15000'.format(modelname, beta_num-1)
