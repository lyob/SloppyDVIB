'''
Based on mnistvib_blyo_edit.py, but includes extra code that allows you to extract
previously trained models and view the data (e.g. size of data structures and values of 
individual tensors).
'''
...
savepth = saver.save(sess, './DATA/mnistvib_20', global_step) ## data is stored here
