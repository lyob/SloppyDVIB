...
savepth = saver.save(sess, './DATA/mnistvib_reduced100', global_step) ## data is stored here
...
#%%
## data extraction 
modelPath = './DATA/mnistvib_reduced100-120000' # trained model (graph/meta, index, data/weights)
graphfile = './DATA/mnistvib_reduced100-120000.meta' # the model used in training
