'''
Extracts data from saved checkpoint files. 
'''
...
#%%
# paths
modelPath = './DATA/mnistvib_reduced-120000'
graphfile = './DATA/mnistvib_reduced-120000.meta'
newSavePath = './DATA/modified_reduced'
...
# more useful data
num_terms = 20
lgt = lg[:num_terms] # output layer (prob) 
oht = oh[:num_terms] #
ohc = np.argmax(oht, axis=1)
rst = rs[:num_terms]
first = lgt[0]


print("labels:       ", ohc)
print("result values:", rst)
print("first output: ", first)
